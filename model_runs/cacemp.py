...
from deeporb.cace_a_2 import CaceA
...
representation = CEONet(64,cutoff=cutoff,n_rbf=8,n_rsamples=8,lomax=2,layers=4,num_message_passing=num_message_passing)
