...
LOGS_NAME = f"qh9_virt_t{TRAINING_SIZE}"
DATA_NAME = "qh9_110k_virt.h5"
...
task.fit(data,dev_run=dev_run,max_epochs=MAX_EPOCHS,chkpt=chkpt,progress_bar=progress_bar)
